  ...
  <div class="authority">
    <div class="gva-table-box">
      <div class="gva-btn-list">
        <el-button size="small" type="primary" icon="plus" @click="addAuthority(0)">新增岗位</el-button>
      </div>
      <el-table
        :data="tableData"
        ...
        style="width: 100%"
      >
        <el-table-column label="岗位ID" min-width="180" prop="authorityId" />
        <el-table-column align="left" label="岗位名称" min-width="180" prop="authorityName" />
    ...
    <el-dialog v-model="dialogFormVisible" :title="dialogTitle">
      <el-form ref="authorityForm" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="岗位ID" prop="authorityId">
          <el-input v-model="form.authorityId" :disabled="dialogType=='edit'" autocomplete="off" />
        </el-form-item>
        <el-form-item label="岗位姓名" prop="authorityName">
    ...
    <el-drawer v-if="drawer" v-model="drawer" custom-class="auth-drawer" :with-header="false" size="40%" title="岗位配置">
      <el-tabs :before-leave="autoEnter" type="border-card">
        <el-tab-pane label="岗位菜单">
          <Menus ref="menus" :row="activeRow" @changeRow="changeRow" />
        </el-tab-pane>
        <el-tab-pane label="岗位api">
...
const rules = ref({
  ...
  parentId: [
    { required: true, message: '请选择父岗位', trigger: 'blur' },
  ]
})

  ...
  <div>
    <div class="gva-table-box">
      ...
      <el-table :data="tableData" row-key="ID">
        ...
        <el-table-column align="left" label="图标" min-width="140" prop="menuIcon" />
        <el-table-column align="left" label="路由Path" show-overflow-tooltip min-width="160" prop="menuUri" />
